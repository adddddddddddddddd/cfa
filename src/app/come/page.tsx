...
const tiers = [
  {
    ...
    href: '#',
    priceMonthly: '$0',
    description: "Continue with the free version of our product.",
    features: [
      'access to climate analysis',
      'Basic building analytics with only a few parameters',
    ],
    featured: false,
  },
  {
    ...
    href: '#',
    priceMonthly: '$99',
    description: 'Have a complete version of our product with all the features you need.',
    features: [
      'Unlimited Climate Simulations',
      'AI-powered analytics',
      'Advanced building analytics with all parameters',
      'Dedicated support representative',
      'Access to all the charts and data',
      'Access to design suggestions',
      'Be part of a community of premium users',
    ],
    featured: true,
  },
];
  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 p-4">
        <Image src={LogoCFA} alt="Logo CFA" width={140} height={140} />
      </div>
      <div aria-hidden="true" className="absolute inset-x-0 -top-3 -z-10 transform-gpu overflow-hidden px-36 blur-3xl">
        <div
          ...
          className="mx-auto aspect-1155/678 w-[72.1875rem] bg-linear-to-tr from-[#ff0000] to-[#ff0000] opacity-30"
        />
      </div>
      <div className="mx-auto max-w-4xl text-center">
        {/* <h2 className="text-base/7 font-semibold text-red-600">Premium Offer</h2> */}
